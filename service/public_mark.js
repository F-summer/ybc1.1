...
var allServerApi={
  getPublicNewsList:function(data,success,error){
    allGlobal.request({
      url: allGlobal.getServerUrl('api/mp/api.ashx?action=c7a41a77-2dfd-4af9-8dfd-4fe8416abada'),
  ...
  //获取公众号顶部信息
   getPublicNewsInfo: function (data, success, error) {
    allGlobal.request({
      url: allGlobal.getServerUrl('api/mp/api.ashx?action=0d73ab3c-25bb-4eb1-ad8d-38b49085626a'),
      contType: "application/x-www-form-urlencoded",
      method: 'POST',
      data: data,
      success: success,
